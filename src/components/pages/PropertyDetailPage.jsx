...
const inquiryData = {
  ...
  return (
    ...
    <motion.button
        ...
        <ApperIcon name="ArrowLeft" size={20} />Back to listings
              </motion.button>
    {/* Property Images */}
    <motion.div
        initial={{
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="lg:col-span-2">
            <motion.div
                ...
                <div className="grid grid-cols-4 gap-4 mb-6">
                    ...
                    <div className="text-center p-4 bg-gray-50 rounded-lg">
                        ...
                        <div className="font-semibold text-gray-900">{property.squareFeet?.toLocaleString() || "N/A"}</div>
                ...
                <div className="border-b border-gray-200 mb-6">
                    <nav className="flex space-x-8">
                        {tabs.map(tab => <button
                            ...
                            className={`flex items-center gap-2 py-4 px-1 border-b-2 font-medium text-sm transition-colors duration-200 ${activeTab === tab.id ? "border-primary text-primary" : "border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300"}`}>
            ...
            <motion.div
                ...
                className="bg-white rounded-xl shadow-lg p-6 mb-6">
                <h2 className="text-2xl font-display font-bold text-gray-900 mb-6">Neighborhood Statistics
                                </h2>
        ...
        <div className="lg:col-span-1">
            <motion.div
                ...
                <div className="space-y-4">
                    <Button onClick={handleScheduleTour} className="w-full" icon="Calendar">Schedule Tour
                                      </Button>
                    <Button
                        onClick={handleContact}
                        variant="secondary"
                        className="w-full"
                        icon="Phone">Contact Agent
                                      </Button>
                    <Button
        ...
        <motion.div
            ...
            <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                    <h2 className="text-2xl font-display font-bold text-gray-900">Contact Agent
                                        </h2>
                    <button
                ...
                <form onSubmit={handleContactSubmit} className="space-y-4">
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <Button type="submit" loading={contactLoading} className="flex-1" icon="Send">Send Message
                                              </Button>
                    </div>
                </form>
            </div>
